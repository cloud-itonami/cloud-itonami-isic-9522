...
This repository designs a forkable OSS business for repair of household appliances and home and garden equipment -- diagnosing and repairing washing machines, lawn mowers and similar equipment for customers -- run by a qualified operator so a community or
...
the physical domain work**. Here a diagnostic-bench robot assists physical appliance testing and repair,
under an actor that proposes actions and an independent **Repair Shop Governor**
...
approval and audit evidence: performing a repair or returning an appliance to the customer.
...
The governed actor implementation (`RepairOps-LLM` + `Repair Shop Governor` as
