# Operator Quickstart — Repair of household appliances and home and garden equipment

Shortest path from clone to a verified local dry-run for **ISIC 9522** (`cloud-itonami-isic-9522`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9522.git
cd cloud-itonami-isic-9522
```
...
- Blueprint governor key: `repair-shop-governor`
- Likely source path: `applianceshop.governor.cljc`
